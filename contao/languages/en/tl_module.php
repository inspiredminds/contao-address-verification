...
$GLOBALS['TL_LANG']['tl_module']['address_show_only_verified_nodes'] = ['Show only verified nodes', 'Shows only the nodes of the address group where the verified address was found.'];
