...
$GLOBALS['TL_LANG']['tl_address']['new'] = ['Create new address', 'Creates a new address.'];
$GLOBALS['TL_LANG']['tl_address']['edit'] = ['Edit address ID %s', 'Edit address ID %s'];
$GLOBALS['TL_LANG']['tl_address']['import'] = ['Import', 'Import from CSV'];
$GLOBALS['TL_LANG']['tl_address']['address_legend'] = 'Address';
